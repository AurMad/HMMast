...
transformed parameters{
  ...
  array[n_obs] vector[K] alpha;
  // definition of alpha and logalpha for the forward algorithm
  array[n_obs] vector[K] logbeta;
  array[n_obs] vector[K] beta;
...
draws <- draws[,-grep("alpha", colnames(draws))]
draws <- draws[,-grep("beta", colnames(draws))]
